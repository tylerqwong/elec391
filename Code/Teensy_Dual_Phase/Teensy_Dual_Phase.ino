...
//Input Setpoints
int rotation_counter_setpoint = 10;
...
void setup() {
  ...
  rotation_counter = 0;
  setpoint = rotation_counter_setpoint*400 + 0/*(counter_setpoint)*/;
}
...
ISR(TIMER1_OVF_vect) //interrupt service routine for timer 1
{
  ...
  TCNT1 = 64911; //Timer runs between 64911 and 65536 for 1000Hz PID refresh   
}
*/
